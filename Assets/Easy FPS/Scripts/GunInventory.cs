...
public class GunInventory : MonoBehaviour {
	...
	*/
	...
	void Update(){
		...
		if(switchWeaponCooldown > 1.2f && ControlFreak2.CF2Input.GetKey(KeyCode.LeftShift) == false){
			Create_Weapon();
		}
	...
	void Create_Weapon(){
		 ...
		 */
		if(ControlFreak2.CF2Input.GetKeyDown(KeyCode.UpArrow) || ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") > 0){
		...
		if(ControlFreak2.CF2Input.GetKeyDown(KeyCode.DownArrow) || ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") < 0){
			switchWeaponCooldown = 0;
		 ...
		 * Keypad numbers
		 */
		if(ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha1) && currentGunCounter != 0){
			switchWeaponCooldown = 0;
			currentGunCounter = 0;
			StartCoroutine("Spawn",currentGunCounter);
		}
		if(ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha2) && currentGunCounter != 1){
			switchWeaponCooldown = 0;
			currentGunCounter = 1;
			StartCoroutine("Spawn",currentGunCounter);
		}
