...
void FixedUpdate(){
	 ...
	 */
	if(ControlFreak2.CF2Input.GetAxis("Fire2") != 0){
...
void MouseInputMovement(){
	...
	wantedYRotation += ControlFreak2.CF2Input.GetAxis("Mouse X") * mouseSensitvity;

	wantedCameraXRotation -= ControlFreak2.CF2Input.GetAxis("Mouse Y") * mouseSensitvity;
