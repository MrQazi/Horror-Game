...
public class PlayerMovementScript : MonoBehaviour {
	...
	*/
	void PlayerMovementLogic(){
		...
		if (grounded) {
			rb.AddRelativeForce (ControlFreak2.CF2Input.GetAxis ("Horizontal") * accelerationSpeed * Time.deltaTime, 0, ControlFreak2.CF2Input.GetAxis ("Vertical") * accelerationSpeed * Time.deltaTime);
		} else {
			rb.AddRelativeForce (ControlFreak2.CF2Input.GetAxis ("Horizontal") * accelerationSpeed / 2 * Time.deltaTime, 0, ControlFreak2.CF2Input.GetAxis ("Vertical") * accelerationSpeed / 2 * Time.deltaTime);
	...
	*/
	void Jumping(){
		if (ControlFreak2.CF2Input.GetKeyDown (KeyCode.Space) && grounded) {
